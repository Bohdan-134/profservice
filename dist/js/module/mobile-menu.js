...
function closeMobileMenu(){const wrapper=document.querySelector('.mobile-menu-wrapp');wrapper.classList.remove('mobile-menu-open');wrapper.classList.add('mobile-menu-close');setTimeout(()=>wrapper.remove(),1900)}
